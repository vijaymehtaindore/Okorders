...
ActiveRecord::Schema.define(version: 2020_04_26_164738) do
  ...
  create_table "followings", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "questions", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "question_name", default: "", null: false
